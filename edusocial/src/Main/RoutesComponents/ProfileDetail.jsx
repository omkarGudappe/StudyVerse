    ...
    return (
        <div className="relative min-h-screen bg-neutral-900 h-screen text-white flex flex-col items-center justify-center p-4">
            ...
            <div className=' flex items-center flex-col justify-center h-full '>
                <div className="w-full max-w-md bg-neutral-800/50 rounded-xl shadow-2xl shadow-gray-900 border border-gray-700 overflow-hidden z-30 transparent-smoke flex flex-col max-h-screen">
                    <div className="p-6 overflow-auto flex-1">
                        <h1 className="text-2xl font-bold text-center mb-6 text-white">Complete Your Profile</h1>
                        
                        {error && (
                            <div className={`${error === "User created successfully" || error === "Profile updated successfully" ? "bg-green-500/20 border-green-500 text-green-200" : "bg-rose-600 text-rose-200"} mb-4 p-3 rounded-lg flex items-start sticky top-0 z-20`}>
                        ...
                        <form onSubmit={handleSubmit} id="profileForm" className="space-y-4">
                            {/* Basic Information */}
                    ...
                    <div className="px-6 py-4 bg-neutral-800/30 border-t border-gray-700 flex space-x-3 z-40">
                        <button
                            type="submit"
                            form="profileForm"
                            disabled={loading}
