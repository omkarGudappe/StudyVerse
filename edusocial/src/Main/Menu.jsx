...
// //       label: "Home",
// //       icon: (
// //         <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 flex" viewBox="0 0 640 640" fill="currentColor">
...
// //       <motion.div className={`hidden md:flex h-screen bg-gradient-to-b from-neutral-900 to-neutral-800 border-r border-neutral-700 sticky top-0 flex-col`}
// //         animate={{ width: SearchClicked ? 80 : 320 }}
// //         style={{ width: SearchClicked ? 80 : 320 }}
// //         transition={{ type: "spring", stiffness: 300, damping: 30 }}
// //       >
// //         <div className="flex items-center p-6 border-b border-neutral-700">
// //           <img
// //             src="/LOGO/StudyVerseIcon.png"
// //             alt="Study Verse Logo"
// //             className="w-12 h-12"
// //           />
// //           <h1 className="text-white text-2xl font-bold ml-3 bg-gradient-to-r from-purple-400 to-amber-400 bg-clip-text">
// //             StudyVerse
// //           </h1>
// //         </div>
...
// //                 }`}
// //               >
// //                 <div className={`w-6 h-6 flex items-center justify-center ${activeBtn === item.id ? "text-purple-400" : "text-neutral-400"}`}>
// //                   {item.icon}
// //                 </div>
// //                 {!SearchClicked && <span className="font-medium">{item.label}</span>}
// //               </Link>
// //             ))}
// //           </div>
// //         </div>
...
// //                 }`}
// //               >
// //                 <div className={`w-6 h-6 ${activeBtn === item.id ? "text-purple-400" : "text-neutral-400"}`}>
// //                   {item.icon}
// //                 </div>
// //                 {!SearchClicked && <span className="font-medium">{item.label}</span>}
// //               </Link>
...
// //       <div className="md:hidden fixed bottom-0 left-0 right-0 bg-neutral-900 border-t rounded-tl-2xl rounded-tr-2xl border-neutral-700 z-50 shadow-2xl">
...
// //                 activeBtn === item.id
// //                   ? "border-b-3 border-purple-600 text-white"
...
//             <Link
//               key={item.id}
//               to={item?.id !== "upload" ? item?.id !== "search" ? `/${item?.id}` : "#" : "#"}
//               onClick={() => handleMenuItemClick(item.id, item.action)}
          ...
          <div className="grid grid-cols-5 gap-1 pt-2 pb-3">
            {mobileMenuItems.map((item) => (
              <Link
                ...
                onClick={() => {
                  if (item.id === "more") {
                    // Handle "More" menu - could show a dropdown or additional options
