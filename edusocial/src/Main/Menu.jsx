...
//       </svg>
//       ),
//       action: () => setOpneNotesTitleModel(!OpneNotesTitleModel),
//     },
//     {
//       id: "notification",
//       label: "Notifications",
...
//   console.log("my current location",location.pathname)
...
const Menu = () => {
  ...
  useEffect(() => {
    ...
    // For non-route items (like modals), we don't change the activeBtn
  }, [location.pathname]);
