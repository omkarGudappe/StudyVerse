...
const OpenPostModal = ({ open, onClose, Id }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-75 backdrop-blur-md">
            <div className="relative w-full max-w-6xl max-h-[90vh] bg-neutral-950 rounded-lg overflow-hidden flex flex-col md:flex-row">
                {/* Close button */}
                <button 
                    onClick={onClose}
                ...
                {isMobile ? (
                    <div className="w-full h-full flex flex-col">
                        {/* Post content section - Centered */}
                        <div className="flex-1 flex items-center justify-center bg-black p-2">
                            {loading ? (
                                <div className="w-full h-64 bg-neutral-900 animate-pulse rounded"></div>
                        ...
                        {/* Right side fixed panel for mobile */}
                        <div className="fixed right-4 top-1/2 transform -translate-y-1/2 z-10 flex flex-col items-center space-y-6">
                            {/* Like button and count */}
                            <div className="flex flex-col items-center">
                                <button className="text-white hover:text-red-500 transition-colors p-2 bg-neutral-800/80 rounded-full backdrop-blur-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                    </svg>
                                </button>
                                {loading ? (
                                    <div className="h-4 w-6 bg-neutral-800 animate-pulse rounded mt-1"></div>
                                ) : (
                            ...
                            {/* Comment button */}
                            <div className="flex flex-col items-center">
                                <button className="text-white hover:text-blue-500 transition-colors p-2 bg-neutral-800/80 rounded-full backdrop-blur-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            {/* Share button */}
                            <button className="text-white hover:text-green-500 transition-colors p-2 bg-neutral-800/80 rounded-full backdrop-blur-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {/* Bottom panel with profile and caption */}
                        <div className="bg-neutral-900/90 backdrop-blur-sm p-4 border-t border-neutral-800">
                        ...
                        <div className="md:w-5/12 flex flex-col border-l border-neutral-800">
                            ...
                            <div className="flex-1 overflow-y-auto p-4">
                                ...
                                {loading ? (
                                    ...
                                    <div className="space-y-4">
                                        {post.comments.map(comment => (
                                            <div key={comment._id} className="flex space-x-3">
                                                <img 
                                                    src={comment.author.UserProfile?.avatar?.url || '/default-avatar.png'} 
                                    ...
                                    <p className="text-neutral-500 text-center py-8">No comments yet</p>
                                )}
                            </div>
                            ...
                            <div className="p-4 border-t border-neutral-800">
                                <div className="flex space-x-2">
                                    ...
                                    />
                                    <button className="text-blue-500 font-semibold px-3 hover:text-blue-400 transition-colors">
                                        Post
                                    </button>
                                </div>
                            </div>
