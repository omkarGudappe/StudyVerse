        ...
        if (res.data.ok) {
            ...
            if (Array.isArray(commentsData)) {
                if (loadMore) {
                    ...
                    // Replace comments when loading first page
                    setComments(commentsData);
                }
                
                // Update pagination info
                setHasMoreComments(res.data.pagination?.hasNextPage || false);
                                    ...
                                    {Loading ? (
                                        ...
                                        <>
                                            {comments.map((comment) => (
                                                <div key={comment?._id} className="rounded-xl p-2">
                                                    <div className="flex items-start space-x-3">
                                                        <div className="flex-shrink-0">
                                                            {comment?.author?.avatar ? (
                                                                ...
                                                                <div className="w-6 h-6 bg-gradient-to-r from-purple-600 to-amber-500 rounded-full flex items-center justify-center text-white font-semibold text-xs">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="flex items-center justify-between space-x-2 mb-1">
                                                                <span className="font-serif font-mono text-sm text-purple-400">
                                            ...
                                            {hasMoreComments && (
                                                <div className="flex justify-center pt-4">
                                                    <button
                                                        ...
                                                        className="px-6 py-2 bg-neutral-700/50 hover:bg-neutral-600 rounded-full text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                                                    >
